...
function main()
{
     ...
     for (var i = 0, len = pions.length; i < len; i++)
     {
         pions[i].addEventListener("click", function()
         {
              ...
              if (!estValide(this))
              {
                  afficheur.sendMessage("Cette case est occupée ! <br />Joueur " + joueurs[tour] + " c'est toujours à vous !");
              ...
              else
              {
                  ...
                  if(jeuEstFini)
                  {
                      afficheur.sendMessage("BRAVO !! Le joueur " + joueurs[tour] + " a gagné ! <br /> <a href=\"index.html\">Rejouer</a>");
                      return;
                  }
